...
@pytest.fixture
def _reset_slashing_detected_metric(vero: Vero) -> None:
    # Resets the value of this metric
    # before each test
    vero.metrics.slashing_detected_g.set(0)
...
async def test_handle_slashing_event(
    ...
    if not our_validator_affected:
        ...
        assert vero.metrics.slashing_detected_g._value.get() == 0
    ...
    if our_validator_affected:
        ...
        assert vero.metrics.slashing_detected_g._value.get() == 1
